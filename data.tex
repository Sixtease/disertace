...
\item{a prvků na cestě k~Bohu obecně.}
\end{itemize}
...
Prvním z~nich jsou strojově psané indexy MUDr. Elgra k~magnetofonovým
...
Krom toho existují podrobnější indexy taktéž od dr. Elgra ve formě listů
...
Dále Ing. Tulach v~rámci tohoto projektu po přepisu přednášky učinil vždy
...
začal digitalizovat já. Formát pro digitalizaci, který jsem používal, byl
