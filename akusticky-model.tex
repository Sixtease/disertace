...
\section{Štěpení mixtur}

Kde gaussova distribuce nedokonale modeluje některý foném, ať už proto, že
jeden foném mívá různé realizace, nebo proto, že rozdělení má jiný tvar než
gaussián, lze vyšší přesnosti modelování dosáhnout tím, že jeden foném
reprezentujeme množinou vážených gaussovských rozdělení, součet jejichž vah je
roven jedné. Pokud je foném gaussiánem modelován dobře, rozdělení na dvě mixtury
...
Hledání probíhá tak, že se rozštěpí nějaká množina gaussiánů na dvě o~téměř
totožné váze, provedou se typicky dvě trénovací iterace a zjistí se, o kolik se
zvedla či snížila úspěšnost. Výsledný model se pak může nebo nemusí vzít jako
základ pro další štěpení.

Štěpí se obvykle vnitřní stavové modely jednotlivých fonémů. Optimální počet
...
z~nich, nemělo by to ovlivnit optimální počet mixtur u~jiného. Druhou pomocí je
mechanismus zabudovaný do HTK, který odstaví všechny mixtury, které po
natrénování mají příliš malou váhu. Můžeme proto beze strachu štěpit mnoho
modelů najednou a mixtury s~malou vahou se pak automaticky odfiltrují.

Typicky se tedy rozštěpí všechny modely najednou a toto se opakuje, dokud
úspěšnost nezačne klesat. Kupodivu, pokoušel jsem se-li štěpit modely náležející
každému monofonému zvlášť, nikdy jsem nedospěl k~tak dobrému výsledku, jako
štěpením všech najednou.
