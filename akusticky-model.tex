...
O~kontext obohacené fonémy dostanou kopie modelů svých původců.
% TODO

Rozhodovací strom pro nalezení shluků fonému vhodných pro sloučení stavů jsem
vybudoval velice podobný jako předkládá příklad v~HTK book, který vychází i
z~příkladu od~dr. Peterka.
...
distribucí, nýbrž složením několika.

Ideální počet mixtur pro každý foném není triviální nalézt. Neznám lepší metodu,
než jeden či více fonémů rozštěpit a na~heldout datech vyzkoušet, zda došlo 
ke~zlepšení či nikoliv. Každé takové otestování trvá několik minut a fonémů je 45,
takže prozkoušení všech variant je časové neúnosné.

Kupodivu, kdykoliv jsem zkoušel štěpit jednotlivé fonémy, nikdy jsem nedospěl
k~lepšímu výsledku, než štěpením všech najednou.

Úspěšnost někdy nezávisí na~počtu mixtur monotónně.
