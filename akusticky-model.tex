...
úseky v~korpusu kromě testovací sady, kde automatický přepis uvádí vysokou míru
...
2015\cite{lecun2015deep}. Toto neminulo ani rozpoznávání řeči. Gaußovské mixtury
...
markovovský model. Připisuju to jednak chybné aplikaci jazykového modelu a
...
dat je pro tento systém příliš málo, ačkoliv manuál i diskuze na fóru napovídají
o opaku.
...
dělen počtem slov ve zlatém standardu} a 54.68\% word accuracy\footnote{rozdíl
počtu správně určených slov a chybně přidaných slov dělen počtem slov ve zlatém
standardu}.
...
\begin{tabular}{|l|l|l|}
\hline
experiment & násobek word precision & násobek word accuracy \\
\hline
výchozí GMM model  & 1 & 1 \\
vysoké c.m. v~trénovací sadě (sekce~\ref{sec:confident} & TODO & TODO \\
vlastní kepstrální normalizace (sekce~\ref{sec:mfcc-norm} & 1.0007 & 1.0089 \\
DeepSpeech (sekce~\ref{sec:deepspeech} & 0.7668 & -0.177 \\
\hline
\end{tabular}
...
DeepSpeech měl na svědomí mnoho chybných vložení (insertions), čímž se accuracy
