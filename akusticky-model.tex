...
Chybovost rozpoznávání se statisticky významně nezměnila.
...
množině větší úspěšnost než výchozí model trénovaný na všech datech, uvedená
v~tabulce~\ref{tab:csasr:results}.
...
\hline
\makecell{standardní\\ testovací\\ množina (50min)} & 46,3\% & 19,2\% & 23,5\% \\
\makecell{5 minut\\ přebuzených záznamů} & & 45.0\% & 34,8\% \\
\makecell{ 5 minut\\ záznamů pořízených\\ nízkou rychlostí } & & 68,5\% & 42,1\% \\
\makecell{ 1 minuta obzvláště\\ nesrozumitelného záznamu } & & 94,1\% & 75,9\% \\
\makecell{agregovaná testovací\\ sada z~různých dat} & & 77,3\% & \textbf{25,3\%} \\
\hline
\end{tabular}
