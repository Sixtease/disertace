...
\caption{
    ...
    \url{http://radio.makon.cz/zaznam/90-02A\#ts=673.14}
}
\label{fig:spectr-ok}
\end{figure}
...
\caption{
    Výrazné echo.\\
    \url{http://radio.makon.cz/zaznam/90-24A-24.4.90\#ts=664.33}
}
...
\caption{
    Širokopásmový šum.\\
    \url{http://radio.makon.cz/zaznam/92-04A\#ts=691.37}
}
...
\caption{
    Úzkopásmový šum.\\
    \url{http://radio.makon.cz/zaznam/92-03B\#ts=664.43}
}
...
\caption{
    ...
    \url{http://radio.makon.cz/zaznam/88-04A\#ts=678.94}
}
\label{fig:spectr-nohi}
\end{figure}

%\begin{figure}[htpb]
%\includegraphics[scale=0.88]{rc/spectrum-overdrive-91-20A.png}
%\caption{
%    Přebuzení.
%    \url{http://radio.makon.cz/zaznam/91-20A\#ts=600.00}
%}
...
\caption{
    ...
    \url{http://radio.makon.cz/zaznam/90-18A-XX-zrychlene\#ts=2473.56}
}
...
\caption{
    ...
    \url{http://radio.makon.cz/zaznam/kotouc-plzen-neident01-a\#ts=660}
}
...
\caption{
    Pomalá mluva.\\
    \url{http://radio.makon.cz/zaznam/76-04A-Kaly-7-IEOUA\#ts=13.79}
}
...
\caption{
    Rychlá mluva.\\
    \url{http://radio.makon.cz/zaznam/89-11B\#ts=203.17}
}
