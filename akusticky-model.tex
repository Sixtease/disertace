...
Není mi známo, že by existoval nějaký systém rozpoznávání řeči založený čistě na
pravidlech. Na druhou stranu systémy založené čistě na informaci z~trénovacích
dat existují, ovšem objevují se až v~posledních letech při rozmachu hlubokých
neuronových sítí.
