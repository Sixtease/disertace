...
Modeluje se skrytými markovovskými řetězci. Všechny hlásky se inicializují jako
...
Kromě vlastních hlásek (viz níže sekci~\ref{sec:ac:fonetika}) přidám ještě hlásku
pro~ticho (\texttt{sil}).
...
mixtur je tedy potřeba zjistit pro trojnásobek počtu použitých trifónů. To
jsou řádově tisíce až desítky tisíc. V~okamžiku psaní tohoto textu používám 8444
reálných trifónů; 13746, počítám-li i ty virtuální. To znamená přes dvacet pět
...
logických hlásek, t.j. u~všech markovovských modelů. Provedou se čtyři trénovací
...
Používám základní hlásky českého jazyka\cite{palkova1992fonetika}
...
V~závislosti na~množství trénovacích dat bylo vhodné nahradit některé hlásky
...
\section{Spojování trifónů}

Pro slučování modelů jednotlivých trifónů, jak zmiňuje
...
hlásek. Umožňují i přímo modelovat grafémy na základě parametrizovaného zvuku, tedy
