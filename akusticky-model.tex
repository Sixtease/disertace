...
\begin{tabular}{|l|l|l|}
\hline
testovací data      & \makecell{standardní\\ testovací\\ množina (50min)}
                             & \makecell{5 minut\\ přebuzených záznamů}
                                      & \makecell{
                                          5 minut\\ záznamů pořízených\\
                                          nízkou rychlostí
                                      }
                                               & \makecell{
                                                   1 minuta obzvláště\\
                                                   nesrozumitelného záznamu
                                               } \\
\hline
výchozí GMM model   & 46,3\% &        &        & \\
\makecell{
    DNN trénovaný\\ na Makoňovi
}                   & 19,2\% & 45.0\% & 68,5\% & 94,1\% \\
\makecell{
    DNN trénovaný\\ na různých sadách
}                   & 23,5\% & 34,8\% & 42,1\% & 75,9\% \\
\hline
\end{tabular}
