...
jak je pojmenovat. Že způsob uložení souborů hraje roli, dokládá i Reppen\cite{reppen2010building}. Zvolil jsem tento formát:
...
Webovou aplikaci je potřeba dále zdokonalovat s~ohledem na UX. Jednak bych rád
dále snížil potřebu zaškolení uživatele zpřehledňováním ovládacích prvků a
integrací vhodného systému nápovědy. Jednak bych rád odstranil nutnost označovat
úsek, aby ho člověk mohl opravit.
Metody zvýšení použitelnosti webu lze načerpat např. v~knize Jana Řezáče Web
